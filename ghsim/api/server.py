...
def main() -> int:
    ...
    if args.account:
        ...
        print("Live GitHub fetching: ENABLED")
        ...
        print("Starting server without account (fixture-only mode)")
        print("Live GitHub fetching: DISABLED")
        print("Tip: Use --account ACCOUNT to enable live fetching")
